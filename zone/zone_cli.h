...
public:
	...
	static void ActorHelperRun(int argc, char **argv, argh::parser &cmd, std::string &description);
	...
	static void TestReservedActorOwner(int argc, char **argv, argh::parser &cmd, std::string &description);
